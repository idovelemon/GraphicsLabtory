...
public:
    ...
    static int32_t AddObject(const char* meshFile, const char* materialFile);
    static int32_t AddInstanceRenderObject(const char* objectFile, int32_t maxInstance = 256);
    static int32_t AddInstanceRenderObject(const char* meshFile, const char* materialFile, int32_t maxInstance = 256);
