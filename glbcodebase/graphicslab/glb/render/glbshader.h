...
enum {
    ...
    GLB_ENABLE_ALBEDO_TEX,
    GLB_ENABLE_ROUGHNESS_TEX,
    GLB_ENABLE_METALLIC_TEX,
...
static const char* kEnableMacros[] = {
    ...
    "#define GLB_ENABLE_DECAL\n",
    "#define GLB_USE_PARALLEL_LIGHT\n",
    "#define GLB_ENABLE_ALBEDO_TEX\n",
    "#define GLB_ENABLE_ROUGHNESS_TEX\n",
